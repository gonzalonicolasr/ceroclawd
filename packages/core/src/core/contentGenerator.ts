...
export function resolveContentGeneratorConfigWithSources(
  ...
  // Set default baseUrl for Ollama if not provided
  if (authType === AuthType.USE_OLLAMA && !newContentGeneratorConfig.baseUrl) {
...
export async function createContentGenerator(
  ...
  if (authType === AuthType.USE_OPENAI || authType === AuthType.USE_OLLAMA || authType === AuthType.USE_GLM) {
    // Ollama and GLM use OpenAI-compatible API
